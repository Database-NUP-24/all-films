...
films = [
    ...
    ("The Grand Budapest Hotel", "Comedy", "USA/Germany", 2014, "A whimsical story about the adventures of a legendary concierge at a famous European hotel between the wars and the lobby boy who becomes his trusted friend. Directed by Wes Anderson."),
    ...
    ("Pan's Labyrinth", "Fantasy", "Mexico/Spain", 2006, "A young girl in post-Civil War Spain escapes into a mythical world to escape the harsh realities of her life. Directed by Guillermo del Toro."),
